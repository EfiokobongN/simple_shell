...
/**
 * _execute - Execute a command specified by its full path.
 * @command: Full path to the command.
 * @inputs: Pointer to a struct containg relevant var.
 *
...
/**
 * find_path - Find the PATH enviroment var.
 * @env: An array of environment var.
 *
 ...
 * @inputs: Poiter to a struck containing var.
 *
 * Return: void.
 */
...
/**
 * exec_cwd - Executes the command in the current working dir.
 * @inputs: Pointer to a struct of relevant var.
 *
...
/**
 * check_dir - Checks if the command contains a dir path.
 * @str: Command string.
 *
 * Return: 1 on success (contains a dir path), 0 on failure.
 */
